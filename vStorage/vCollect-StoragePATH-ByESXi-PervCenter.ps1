...
################################# 
$ReportInfo="Storage PATH per ESXi for each vCenter Info Report"
...
foreach ($vCenter in $vCenterList){
	...
	If($? -Eq $True){
        ...
        $Report = ForEach ($esxi in $esxihosts) {            
            ...
            ###############################
            Write-Host "Gathering HBAs Informations"    -Foregroundcolor "Cyan"
            $j=0
            ForEach ($hba in $hbas) {
                $j++                
                ...
                ###############################
                Write-Host "Gathering Luns Informations"    -Foregroundcolor "Cyan"
                $k=0
                ForEach ($scsilun in $scsiluns) {
                    ...
                    ################################
                    Write-Host "Gathering Paths Informations"   -Foregroundcolor "Cyan"
                    $l=0
